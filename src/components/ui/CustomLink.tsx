...
export default function CustomLink({
  ...
  return (
    <Link
      className={cn(
        "w-full rounded-[8px] border border-grey-15 px-[20px] py-[14px] text-center text-[14px] font-medium transition dt:rounded-[10px] dt:px-[24px] dt:py-[18px] dt:text-[18px]",
        {
